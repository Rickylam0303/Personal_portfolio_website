...
const Data = () => {
  return (
    <div className="home__data">
      ...
      <h3 className="home__subtitle">Data Science Student</h3>
      <p className="home__description">
        I'm actively seeking an internship where I can grow and contribute to a
        dynamic team. Feel free to download my CV for more detailed information.
      </p>
      ...
      >
        <i className="uil uil-file-download" style={{ fontSize: "2rem", marginRight: "8px" }}></i>
        Download resume
      </a>
    </div>
  );
